  ...
  return (
    <div className='h-screen' style={{ backgroundColor: "#121415" }}>
      <div className=" p-8 flex flex-col md:flex-row justify-center items-center gap-28">
        ...
        {/* Card 2 */}
        <a href="/home"><div className="card rounded-lg p-6 text-center border border-neutral-500">
        ...
        {/* Card 3 */}
        <a href="/profile"><div className="card rounded-lg p-6 text-center border border-neutral-500">
